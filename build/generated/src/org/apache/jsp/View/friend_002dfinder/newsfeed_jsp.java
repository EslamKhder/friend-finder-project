...
public final class newsfeed_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("                                            <a  onclick=\"sendLike(");
            out.print(Postid.getIdpost());
            out.write(")\" class=\"btn text-green\"><i class=\"icon ion-thumbsup\"></i><i id=\"likes\">");
            ...
            out.write("                                            <form action=\"../../addComment\">\n");
            out.write("                                            <div class=\"post-comment\">\n");
            out.write("                                                <img src=\"images/users/user-1.jpg\" alt=\"\" class=\"profile-photo-sm\" />\n");
            out.write("                                                <input type=\"text\" name=\"comment\" class=\"form-control\" placeholder=\"Post a comment\" />\n");
            ...
            out.write("\" />\n");
            out.write("                                                <input class=\"done\" type=\"submit\" value=\"done\" />\n");
            out.write("                                            </div>\n");
            out.write("                                        </form>\n");
            out.write("                                    </div>\n");
            out.write("                                </div>\n");
      ...
      out.write("            function sendLike(x)\n");
      out.write("            {\n");
      out.write("                alert(x);\n");
      out.write("                var url = \".../../addLike?id=\" + x;\n");
      ...
      out.write("                        likes = document.getElementById(\"likes\");\n");
      out.write("                    \n");
      out.write("                    if(val == \"remove\"){\n");
      out.write("                        likes.innerHTML = likes.innerHTML - 1;\n");
      out.write("                    } else if(val == \"add\") {\n");
      out.write("                        likes.innerHTML = likes.innerHTML + 1;\n");
